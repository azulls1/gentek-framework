...
4. Por cada Must, escribe `.gentek/specs/<slug>.md` con: problema, user story, ACs (Given/When/Then), casos edge, NO-scope, dependencias.
5. Máximo 5 Must en MVP. Si tienes más, no es MVP.

# Outputs (usar Write)
- `.gentek/PRD.md` — vista global priorizada
